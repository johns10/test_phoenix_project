defmodule TestPhoenixProject.MixProject do
  ...
  def application do
    [
      mod: {TestPhoenixProject.Application, []},
  ...
  defp deps do
    [
      ...
      {:sexy_spex, path: "/Users/johndavenport/Documents/github/spex", only: [:test, :dev]}
    ]
  end
  ...
  defp aliases do
    [
      ...
      "assets.deploy": [
        "tailwind test_phoenix_project --minify",
        "esbuild test_phoenix_project --minify",
        "phx.digest"
      ],
